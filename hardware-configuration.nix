...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/241f9db3-1b40-4f63-8a2c-5b49fdbefaf5";
      fsType = "ext4";
    };

  fileSystems."/boot/efi" =
    { device = "/dev/disk/by-uuid/3FAD-C47C";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/679f4268-d534-491b-8780-5cfeb2ec9c1f"; }
    ];
