...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/98ccd751-6e7f-4c08-82eb-26024a55b864";
      fsType = "ext4";
    };

  fileSystems."/boot/efi" =
    { device = "/dev/disk/by-uuid/B05C-9904";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/de44cbe6-e1bd-48d1-93da-5b7a0023fb9f"; }
    ];
